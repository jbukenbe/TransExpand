function [x_fit_id, y_fit] = new_samp_from_beta(problem, good_plan_threshold)
...
while fit_idx < fit_loop_n    
    ...
    parfor b_idx = 1: between_cleanup_loop
        ...
        if ~isempty(x_subset_id)
            ...
            % remove plans with too many new lines or over budget
            ...
            x_fit = x_fit(x_fit*line_cost < line_budget,:);
