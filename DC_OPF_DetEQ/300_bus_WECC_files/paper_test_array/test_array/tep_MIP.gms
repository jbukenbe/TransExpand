...
1        06/11/2018      JesseB  copy of lf_tep_MIP to run simple weighted avg monte carlo or k means opt

TODO:
         Add renewable limits

$offtext
$include        "WECC_MIP_gams.txt"
...
eObFun..                               z =e= sum(subs, psub_w(subs)*zs(subs))/8760+ sum((cand,i,j)$ii(cand,i,j),y(cand,i,j)*dtl(cand,i,j,'cost'));
